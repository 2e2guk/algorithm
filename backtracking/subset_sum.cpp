...
void sum_of_subsets(int i, int weight, int total, int W, vector<bool>& is_included, vector<int>& w) { // i = 현재 level
...
int main() {
    ...
    sum_of_subsets(0, weight, total, W, is_included, w); // 시작 level은 0이다.
    return 0;
}
